...
from scraper_service.scraper.scrapers import PublicationsScraper
...
class Command(BaseCommand):
    help = 'Run the publications scraper to extract tables from PDF documents on the SNBS website'
    ...
    def handle(self, *args, **options):
        self.stdout.write(self.style.SUCCESS('Starting publications scraper...'))
        ...
        try:
            ...
            logger.exception('Error in run_publications_scraper command')
            
        self.stdout.write(self.style.SUCCESS('Publications scraper finished'))
